...
class MainView(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(
            request, 'myblog/index.html', context={'page_obj': page_obj}
        )
...
class PostDetailView(View):
    def get(self, request, slug, *args, **kwargs):
        ...
        last_posts = Post.objects.exclude(id=post.pk)[:5]
...
class FeedBackView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                send_mail(f'От {name} | {subject}', message, from_email, ['forbebr@gmail.com'])
